...
def build():
    ...
    with open(METADATA / "colombia_municipios.geojson") as f:
        mpio_geo = json.load(f)

    mpio_rows = {}
    cand_cols = []
    mpio_csv = OUT / "results/colombia_2026_municipio_primera.csv"
    if mpio_csv.exists():
    ...
    out_path = OUT / "colombia_2026_municipio_primera.geojson"
    ...
    dept_path = OUT / "colombia_2026_dept_primera.geojson"
